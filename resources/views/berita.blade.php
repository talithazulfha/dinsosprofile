    ...
    <div class="md:flex">
        <div class="md:w-1/3">
            <div class="grid grid-cols-3 gap-1 h-full">
                <img src="/path/to/image1.jpg" alt="Event Image" class="w-full h-full object-cover">
                <img src="/path/to/image2.jpg" alt="Event Image" class="w-full h-full object-cover">
                <img src="/path/to/image3.jpg" alt="Event Image" class="w-full h-full object-cover">
            </div>
        </div>
